    ...
    <section className="relative h-screen flex flex-col" style={{ overflowX: 'clip' }}>
      ...
      <div className="overflow-hidden w-full">
        <GradientHeading
          as="h1"
          delay={0.15}
          className="font-black uppercase tracking-tight leading-none whitespace-nowrap w-full mt-6 sm:mt-4 md:-mt-5 text-[10vw]"
        >
          hi, i&apos;m husain
        </GradientHeading>
      </div>
      ...
      <div className="mt-auto flex justify-between items-end pb-7 sm:pb-8 md:pb-10 px-6 md:px-10 relative z-20">
        <FadeIn delay={0.35} y={20}>
          ...
          >
            an aspiring web developer driven by clean code and secure builds
          </p>
        </FadeIn>
